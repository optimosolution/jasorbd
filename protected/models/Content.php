...
class Content extends CActiveRecord {
    ...
    public static function get_images($id) {
        ...
        if ((is_file($filePath)) && (file_exists($filePath))) {
            echo CHtml::image(Yii::app()->baseUrl . '/uploads/images/' . $value->images, 'Picture', array('alt' => $value->title, 'class' => '', 'title' => $value->title, 'style' => 'width:50px;'));
        } else {
            return CHtml::image(Yii::app()->baseUrl . '/uploads/images/default.jpg', 'Picture', array('alt' => $value->title, 'class' => '', 'title' => $value->title, 'style' => 'width:50px;'));
        }
    }
    ...
    public static function get_picture_responsive($id) {
        ...
        $filePath = Yii::app()->basePath . '/../uploads/images/' . $value->images;
        if ((is_file($filePath)) && (file_exists($filePath))) {
            return CHtml::image(Yii::app()->baseUrl . '/uploads/images/' . $value->images, 'Picture', array('alt' => $value->title, 'class' => 'img-responsive', 'title' => $value->title));
        }
    }

    public static function get_latest_content() {
        ...
        echo '<ul class="footer-posts list-unstyled">';
        foreach ($array as $key => $value) {
            echo '<li>';
            echo CHtml::link($value['title'], array('content/view', 'id' => $value['id']), array('class' => ''));
    ...
    public static function get_recent_content() {
        $array = Content::model()->findAll(
                array(
                    'condition' => 'state=1',
                    'order' => 'created DESC, id DESC',
